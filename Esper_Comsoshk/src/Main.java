	...
	public Main(){
		...
		okButton1.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				...
				int type4mailsend= Integer.parseInt(type);
				if(proto.contains("80+9999")){
					type4mailsend=3;
			    }
				else if(proto.contains("135+9191")){
					type4mailsend=4;
				}
				else if(proto.contains("445+4444")){
					type4mailsend=5;
				}
				else if(proto.contains("389+31337")){
					type4mailsend=6;
				}
				else if(proto.contains("135+7175")){
					type4mailsend=7;
				}
				else if(proto.contains("23+2001")){
					type4mailsend=8;
				}
				else if(proto.contains("21+19800")){
					type4mailsend=9;
				}
				mail=userId1.getText();
				label3.append("Notify Mail sent to : "+mail+"...... \n");
				MailThread mt=new MailThread(mail,src,dst,proto,type4mailsend);
